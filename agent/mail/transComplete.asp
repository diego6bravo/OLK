...
<title></title>
<!--#include file="lang/transComplete.asp" -->
<style type="text/css">
.style1 {
	text-align: center;
	font-size: medium;
...
<table border="0" cellpadding="0" width="100%" id="table1">
	...
	<tr>
		...
		<%=gettransCompleteLngStr("DtxtLogNum")%> <:-LogNum-><br>
		<%=gettransCompleteLngStr("LtxtTransNote")%>
		</font></p></td>
	</tr>
	<tr>
		<td>
		...
		<:-CompnyAddr-><br>
		<%=gettransCompleteLngStr("DtxtPhone")%>: <:-Phone1->/<:-Phone2->
		<%=gettransCompleteLngStr("DtxtFax")%>: <:-Fax-><br>
