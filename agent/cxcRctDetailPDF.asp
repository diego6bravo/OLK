...
<%
makeAction = 	"cxcRctDetailPrint.asp?CardCode=" & myHTMLEncode(Request("CardCode")) & "&DocEntry=" & Request("DocEntry") & "&pop=Y&DocType=" & Request("DocType") & _
...
varx = Request.ServerVariables("URL")
	...
	For i = 1 To theDoc.PageCount
	  ...
	  theDoc.Flatten
	Next
'theDoc.Save Server.MapPath(Mid(varx,1,Len(varx)-23) & "temp/") & "\cxcRctDetail.pdf"
theData = theDoc.GetData()
Response.ContentType = "application/pdf"
'Response.AddHeader "content-length", UBound(theData) - LBound(theData) + 1
Response.AddHeader "content-disposition", "inline; filename=cxcRctDetail.pdf"
