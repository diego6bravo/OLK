...
<% addLngPathStr = "" %>
<!--#include file="lang/cardCancel.asp" -->
<%
	If Session("CrdRetVal") <> "" Then
		set cmd = Server.CreateObject("ADODB.Command")
		cmd.ActiveConnection = connCommon
		cmd.CommandType = &H0004
		cmd.CommandText = "DBOLKTransationCancel"
		cmd.Parameters.Refresh()
		cmd("@LogNum") = CLng(Session("CrdRetVal"))
		cmd.Execute()
       Session("CrdRetVal") = ""
    End If
                      %>
...
<table border="0" cellpadding="0" cellspacing="0" width="453">
	...
	<tr>
		...
		<p align="center"><% If Request("isUpdate") = "false" Then %><%=getcardCancelLngStr("LtxtClientCancel")%><% Else %><%=getcardCancelLngStr("LtxtClientUpdCanceled")%><% End If %></td>
		<td>
		<p align="center">
		&nbsp;</td>
		<td>
