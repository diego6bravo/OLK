...
addLngPathStr = "" %>
<!--#include file="lang/activityCancel.asp" -->
<%
	If Session("ActRetVal") <> "" Then
		set cmd = Server.CreateObject("ADODB.Command")
		cmd.ActiveConnection = connCommon
		cmd.CommandType = &H0004
		cmd.CommandText = "DBOLKTransationCancel"
		cmd.Parameters.Refresh()
		cmd("@LogNum") = CLng(Session("ActRetVal"))
		cmd.Execute()
       Session("ActRetVal") = ""
    End If
                      %>
...
<table border="0" cellpadding="0" cellspacing="0" width="453">
	...
	<tr>
		...
		<p align="center"><% If Request("isUpdate") = "false" Then %><%=getactivityCancelLngStr("LtxtActivityCancel")%><% Else %><%=getactivityCancelLngStr("LtxtActivityUpdCancel")%><% End If %></td>
		<td>
		<p align="center">
		&nbsp;</td>
		<td>
