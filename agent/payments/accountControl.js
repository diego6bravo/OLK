...
function clearSelectAccount() { if (tblAcct) { tblAcct.style.display='none'; } }
...
function doSelActLayer(img, id, t, e, data)
{
	...
	var h = t == 'cash' ? '100' : '200';
	
	var strTbl = "<div style=\"border-left:1px solid #757864; border-right:1px solid #757864; border-bottom:1px solid #757864; position: absolute; width: 420px; height: " + h + "px; overflow: scroll; overflow-x: hidden; z-index: 1; background-color: white; display: none; left:10px; top:431px\" id=\"lySelAct" + t + "\"> " + 
	"<table border=\"0\" cellspacing=\"0\" width=\"100%\"> " + 
	"	<tr> " + 
	"		<td onmouseover=\"bgColor='#EBF8FE'\" onmouseout=\"bgColor=''\" style=\"cursor: default; font-face: Verdana; font-size: 10px; color: black; \" onclick=\"setSelAcct('', '', '');\">&nbsp;</td> " + 
	"	</tr> ";
	...
	for (var i = 0;i<arrData.length;i++)
	{
		...
		strTbl += "<tr><td onmouseover=\"bgColor='#EBF8FE'\" onmouseout=\"bgColor=''\" style=\"cursor: default; font-face: Verdana; font-size: 10px; color: black;\" onclick=\"setSelAcct('" + arrCol[0] + "', '" + arrCol[1].replace("'", "\'") + "', '" + arrCol[2] + "');\"><font face=\"Arial\">" + arrCol[2] + " - " + arrCol[1] + "</font></td></tr>";
