<% addLngPathStr = "C_Art/" %>
<!--#include file="lang/searchitemsa.asp" -->
<%
  ...
  <table border="0" cellpadding="0" cellspacing="0" width="100%" style="border-collapse: collapse" bordercolor="#111111">
    <tr>
      ...
      <table border="0" cellpadding="0" bordercolor="#111111" width="100%" id="AutoNumber1">
        ...
        <tr>
          <td width="100%">
          <p align="<% If Session("rtl") = "" Then %>right<% Else %>left<% End If %>"><b><font face="Verdana" size="1"><%=getsearchitemsaLngStr("DtxtCat")%> - <%=getsearchitemsaLngStr("LtxtItemsSearch")%></font></b></td>
        </tr>
        <tr>
          <td width="100%">
...
{
	window.location.href='operaciones.asp?cmd=adSearch&ID=' + ID + '&adObjID=4&slist=<%=Request("slist")%>';
}
//-->
</script>