<% addLngPathStr = "client/" %><!--#include file="lang/clientdel.asp" -->
<% 
If Request("Confirm") = "Y" Then
   sql = "update r3_obscommon..tlog set status = 'B' where lognum = " & Request("RetVal")
   conn.execute(sql)
   Session("CrdRetVal") = "" %>
<table border="0" cellpadding="0" cellspacing="0" width="100%" style="border-collapse: collapse" bordercolor="#111111">
    <tr>
      ...
      <table border="0" cellpadding="0" bordercolor="#111111" width="100%" id="AutoNumber1">
        ...
        <tr>
          <td width="100%">
          <p align="center"><b><font size="1" face="Verdana"><%=getclientdelLngStr("LtxtConfCancel")%></font></b></td>
        </tr>
        <tr>
          <td width="100%">
          <p align="center">
...
<% Else %><table border="0" cellpadding="0" cellspacing="0" width="100%" style="border-collapse: collapse" bordercolor="#111111">
    ...
    <tr>
      ...
      <table border="0" cellpadding="0" bordercolor="#111111" width="100%" id="AutoNumber1">
        ...
        <tr>
          <td width="100%">
          <p align="center"><b><font face="Verdana" size="1"><%=Replace(getclientdelLngStr("LtxtConfDelBP"), "{0}", Session("RetVal"))%></font></b></td>
        </tr>
        <tr>
          <td width="100%">
<table border="0" cellpadding="0" cellspacing="0" style="border-collapse: collapse" bordercolor="#111111" width="100%" id="AutoNumber2" height="15">
  ...
  <tr>
    <td width="40%" height="15">
      ...
      <a href='operaciones.asp?cmd=clientcancel&amp;redir=<%=Request("redir")%>&amp;confirm=Y&RetVal=<%=Session("CrdRetVal")%>'>
