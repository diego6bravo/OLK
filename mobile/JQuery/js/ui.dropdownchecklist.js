...
/*
    ...
    *
    * Copyright (c) 2008-2012 Adrian Tosca, Copyright (c) 2012-2011 Ittrium LLC
...
*/
    ...
    $.widget("ui.dropdownchecklist", {
        ...
        _appendDropContainer: function( controlItem ) {
            ...
            // @todo 22Sept2012 - check if size calculation is thrown off if the parent of the
        ...
        _createDropItem: function(index, tabIndex, value, text, optCss, checked, disabled, indent) {
	        ...
	        // 23Sept2012 - unfortunately, IE 7+ and Chrome like to post a blur
