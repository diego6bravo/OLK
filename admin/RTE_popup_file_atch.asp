...
function showPreview(attached){
	...
	if (extension==".txt" 
	 ...
	 || extension==".bmp"){
		...
		document.getElementById("prevWindow").contentWindow.location.href="RTE/RTE_popup_link_preview.asp?b=0";
      ...
      <td colspan="2" bgcolor="<% = strRTEpopupCentreRowColour %>"><table width="100%" border="0" align="center" cellpadding="1" cellspacing="0">
        <tr>
          <td width="42%" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="2">
            ...
            <tr>
              <td class="text"><% = strTxtFileName %>:<iframe src="RTE/RTE_file_browser.asp" id="fileWindow" width="98%" height="180px" style="border: #A5ACB2 1px solid;backgroundColor: #FFFFFF;"></iframe></td>
            </tr>
          ...
          <form method="post" action="RTE_popup_file_atch.asp" name="frmImageInsrt">
            <table width="100%" border="0" cellspacing="0" cellpadding="2">
              ...
              <tr>
                ...
                <td colspan="5"><iframe src="RTE/RTE_popup_link_preview.asp" id="prevWindow" width="98%" height="220px" style="border: #A5ACB2 1px solid;backgroundColor: #FFFFFF;"></iframe></td>
                </tr>
          </table></td>
        </tr>
      </table></td>
