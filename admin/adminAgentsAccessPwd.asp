...
<!--#include file="lang/adminAgentsAccessPwd.asp" -->
<head>
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
<title><%=getadminAgentsAccessPwdLngStr("LttlChangePwd")%></title>
<style>
<!--
...
function ValidateForm(frm)
{
	...
	{
		alert("<%=getadminAgentsAccessPwdLngStr("LtxtValConfPwd")%>");
		frm.pwd1.value = "";
		frm.pwd2.value = "";
		frm.pwd1.focus();
		return false;
	...
	{
		alert("<%=getadminAgentsAccessPwdLngStr("LtxtValMinChar")%>");
		frm.pwd1.value = "";
		frm.pwd2.value = "";
		frm.pwd1.focus();
		return false;
...
<table border="0" cellpadding="0" width="100%" id="table1" style="font-family: Verdana; font-size: 10px">
	<form method="POST" name="frmPwd" action="<% If Request("UName") <> "" Then %>adminSubmit.asp<% Else %>adminAgentsAccessPwd.asp<% End If %>" onsubmit="javascript:return ValidateForm(this)">
	<tr>
		<td bgcolor="#E1F3FD"><b><font color="#31659C" size="1" face="Verdana">
		&nbsp;<%=getadminAgentsAccessPwdLngStr("LttlChangePwd")%></font></b></td>
	</tr>
	<tr>
		<td bgcolor="#E1F3FD" align="center">
		<font size="1" face="Verdana" color="#3366CC"><%=getadminAgentsAccessPwdLngStr("DtxtUser")%>: <%=Request("UName")%><%=Request("NewName")%></font></td>
	</tr>
	<tr>
	...
	<tr>
		...
		<tr>
		<td bordercolor="#C8E7E8" align="center">
		<font size="1" face="Verdana" color="#3366CC"><%=getadminAgentsAccessPwdLngStr("LtxtMinPwd")%></font></td>
		</tr>
	<tr>
		<td bordercolor="#C8E7E8" align="center">
		<table cellpadding="0" cellspacing="0" border="0">
			<tr>
				...
				<td align="center"><font size="1" face="Verdana" color="#3366CC"><label for="ChangePwd"><%=getadminAgentsAccessPwdLngStr("LtxtChangePwdLog")%></label></font></td>
			</tr>
		</table>
		</td>
	</tr>
	<tr>
		<td bordercolor="#C8E7E8" align="center">
		<input type="submit" value="<%=getadminAgentsAccessPwdLngStr("DtxtAccept")%>" name="B1" class="OlkBtn"></td>
	</tr>
		<input type="hidden" name="submitCmd" value="vUserPwd">
