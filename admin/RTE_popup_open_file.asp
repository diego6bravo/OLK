        ...
        <tr>
          <td width="58%" valign="top">
            <table width="100%" border="0" cellspacing="0" cellpadding="2">
              ...
              <tr>
                <td class="text"><% = strTxtFileName %>:<iframe src="RTE/RTE_file_browser.asp?look=open" id="fileWindow" width="98%" height="215px" style="border: #A5ACB2 1px solid;backgroundColor: #FFFFFF;"></iframe></td>
                <td class="text"><% = strTxtPreview %>:<iframe src="RTE/RTE_popup_link_preview.asp" id="prevWindow" width="98%" height="215px" style="border: #A5ACB2 1px solid;backgroundColor: #FFFFFF;"></iframe></td>
                </tr>
          </table></td>
        </tr>
      </table></td>
