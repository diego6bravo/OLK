...
%>
            <tr>
              <td class="text"><% = strTxtFileName %>:<iframe src="RTE/RTE_file_browser.asp?look=img" id="fileWindow" width="98%" height="180px" style="border: #A5ACB2 1px solid;backgroundColor: #FFFFFF;"></iframe></td>
            </tr>
...
%>
	    <tr>
              <td class="text"><% = strTxtFileName %>:<iframe src="RTE/RTE_file_browser.asp?look=img" id="fileWindow" width="98%" height="278px" style="border: #A5ACB2 1px solid;backgroundColor: #FFFFFF;"></iframe></td>
            </tr>
<%
End If
          ...
          <form method="post" action="RTE_popup_adv_image.asp" name="frmImageInsrt">
            <table width="100%" border="0" cellspacing="0" cellpadding="2">
              ...
              <tr>
                ...
                <td colspan="5"><iframe src="RTE/RTE_popup_image_preview.asp" id="prevWindow" width="98%" height="215px" style="border: #A5ACB2 1px solid;backgroundColor: #FFFFFF;"></iframe></td>
                </tr>
          </table></td>
        </tr>
      </table></td>
