...
Const blnOutdent = false
Const blnIndent = false
Const blnAddHyperlink = true
Const blnAddImage = true
Const blnMyAddImage = false
...
'Advanced controls
'***************************************************************************
Const blnAdvAdddHyperlink = false'Advanced hyperlink control
Const blnAdvAddImage = false	'Advanced image control requires File System Object (FSO)
Const blnHTMLView = true	'Allows the user to view the HTML code, you may need to dsiable this for extra security
Const blnSpellCheck = false	'Requires IEspell for Ineternet Explorer or SpellBound for Mozilla
...
Const blnOpenFile = false 'Open server file in editor (ie. open and HTML page in editor), requires File System Object (FSO)
Const strOpenFileFolderPath = "my_documents"
Const strOpenFileTypes = "htm;html" 'Separate file types with ;

Const blnSave = false 'Save editor contents to server, requires File System Object (FSO)
