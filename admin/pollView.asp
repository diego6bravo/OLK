...
<table border="0" cellpadding="0" cellspacing="1" width="100%" id="table20" bordercolor="#336699" style="border-width: 1px; ">
	<form method="POST" action="Poll/poll/pollSubmit.asp">
	<tr>
		<td bgcolor="#E1F3FD" style="border-left-style: none; border-left-width: medium; border-right-style: none; border-right-width: medium; border-top-style: none; border-top-width: medium"><b>
                  <font size="1" face="Verdana">&nbsp;<%=getpollViewLngStr("LtxtYourOp")%></font></b></td>
	</tr>
	<tr>
		<td bordercolor="#7CBCFC" style="border-bottom-style: solid; border-bottom-width: 1px; border-left-style:none; border-left-width:medium; border-right-style:none; border-right-width:medium"><p align="center"><b>
                              <font size="1" face="Verdana"><%=rd("pollTitle")%>&nbsp;</font></b></td>
	</tr>
	<tr>
		<td bgcolor="#336699" style="border-left-style:none; border-left-width:medium; border-right-style:none; border-right-width:medium; border-top-style:solid; border-top-width:1px; border-bottom-style:solid; border-bottom-width:1px"><p align="center"><b>
                              <font size="1" face="Verdana"><%=FormatDate(rd("pollDate"), True)%>&nbsp;</font></b></td>
	</tr>
	<tr>
		...
		<% If Not rs.eof then
                              ...
                              <% If rs("VotesPercantage") > 0 then %>&nbsp;<img border="0" src="poll/colo<%=rs("colorIndex")%>.gif" width="<%=rs("VotesPercantage")%>" height="12"><% end if %><font face="verdana" size="1"> 
								%<%=rs("VotesPercantage")%></font><br>
                               <% rs.movenext
                            	wend
                            	end if %></td>
	</tr>
		<input type="hidden" name="pollIndex" value="<%=rd("pollIndex")%>">
	<tr>
		<td bgcolor="#F0F8FF" style="border-left-style: none; border-left-width: medium; border-right-style: none; border-right-width: medium; border-bottom-style: none; border-bottom-width: medium; font-size:4px">                              
                                  &nbsp;</td>
	</tr>
		</form>
</table></td>
