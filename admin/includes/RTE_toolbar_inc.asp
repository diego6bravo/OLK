...
If blnMyAddImage Then
	Response.Write("<img src=""" & strRTEImagePath & "post_button_image.gif"" align=""absmiddle"" border=""0"" onClick=""winOpener(\'../upload/fileupload.aspx?ID=" & Session("ID") & "\',\'insertImg\',0,0,300,100)"" title=""" & strTxtAddImage & """ class=""WebWizRTEbutton"" onmouseover=""overIcon(this)"" onmouseout=""outIcon(this)"">")
ElseIf blnAdvAddImage Then
